...
import com.zbkj.admin.adaptor.StatViewServletAdaptor;
import com.zbkj.admin.adaptor.WebStatFilterAdaptor;
...
public class DruidConfig {
    ...
    @Bean
    public ServletRegistrationBean druidServlet() { // 主要实现WEB监控的配置处理 StatViewServlet
