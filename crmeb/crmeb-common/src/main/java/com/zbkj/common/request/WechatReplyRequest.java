...
@Schema(name ="WechatReplyRequest对象", description="微信关键字回复表")
public class WechatReplyRequest implements Serializable {
    ...
    @Schema(name  = "回复类型 text=文本  image =图片  news =图文  voice =音频"  , example = "text")
    ...
    @Schema(name  = "回复状态 0=不可用  1 =可用", example = "1")
