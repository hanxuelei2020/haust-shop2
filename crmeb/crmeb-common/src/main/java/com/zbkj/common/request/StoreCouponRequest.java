...
public class StoreCouponRequest implements Serializable {
    ...
    @Schema(name  = "最低消费，0代表不限制", required = true)
    private BigDecimal minPrice;

    @Schema(name  = "是否固定领取时间， 默认0 否， 1是", required = true)
    ...
    @Schema(name  = "请设置是否固定使用时间, 默认0 否， 1是", required = true)
